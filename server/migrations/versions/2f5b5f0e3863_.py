...
def upgrade():
    ...
    inspector = sa.inspect(context.bind)
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_salaries_user_id_users'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('company', sa.VARCHAR(), nullable=False),
    sa.Column('created_at', sa.DATETIME(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='fk_company_reviews_user_id_user'),
    sa.PrimaryKeyConstraint('id')
    )
